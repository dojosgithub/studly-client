...
export function getContacts() {
  return async () => {
    ...
    try {
      const response = await axios.get('https://minimal-assets-api.vercel.app/api/chat/contacts');
...
export function getConversations() {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get('https://minimal-assets-api.vercel.app/api/chat/conversations');
...
export function getConversation(conversationKey) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get('https://minimal-assets-api.vercel.app/api/chat/conversation', {
...
export function markConversationAsRead(conversationId) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      await axios.get('https://minimal-assets-api.vercel.app/api/chat/conversation/mark-as-seen', {
...
export function getParticipants(conversationKey) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get('https://minimal-assets-api.vercel.app/api/chat/participants', {
        params: { conversationKey },
      });
